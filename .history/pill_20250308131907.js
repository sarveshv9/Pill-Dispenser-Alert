document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateUpcomingAlarm() {
        let alarmTime = localStorage.getItem("pillAlarmTime");
        let pillName = localStorage.getItem("pillName");

        if (alarmTime && pillName) {
            upcomingAlarmDisplay.textContent = Next Alarm: ${pillName} at ${alarmTime};
            upcomingAlarmDisplay.style.color = "blue";
        } else {
            upcomingAlarmDisplay.textContent = "No upcoming alarms.";
            upcomingAlarmDisplay.style.color = "gray";
        }
    }
    ...
    function triggerAlarm() {
        ...
        let pillImage = document.getElementById("pill-image");

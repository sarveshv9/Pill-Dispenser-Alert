...
@app.route('/pill_form')
def pill_form():
    return render_template('pill_form.html')

@app.route('/yoga_form')
def yoga_form():
    return render_template('yoga_form.html')

@app.route('/morning_alarm')
def morning_alarm():
    return render_template('morning_alarm.html')

@app.route('/sleeping_alarm')
def sleeping_alarm():
    return render_template('sleeping_alarm.html')

@app.route('/water_reminder')
def water_reminder():
    return render_template('water_reminder.html')

@app.route('/workout_reminder')
